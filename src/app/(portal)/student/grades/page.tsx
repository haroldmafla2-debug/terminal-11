...
export default function StudentGradesPage() {
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
          <CardTitle>Grades by period</CardTitle>
          <CardDescription>Official grading scale 0.0 to 5.0.</CardDescription>
        </CardHeader>
      </Card>
              ...
              <tbody>
                {studentGrades.map((row) => (
                  <tr key={row.subject} className="border-b border-slate-100">
                    <td className="px-2 py-2 font-medium text-slate-900">{row.subject}</td>
